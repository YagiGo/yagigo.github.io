                ...
                <div className="my-auto">
                    ...
                    <div className="resume-item d-flex flex-column flex-md-row mb-3">
                        <div className="resume-content mr-auto">
                            ...
                            <p><a href="https://axross-recipe.com" target="_blank" rel="noreferrer">Axross</a> is a online education service which provides AI related learning materials for developers who are not very familiar with AI field.
                            </p>
                            <ul>
                    ...
                    <div className="resume-item d-flex flex-column flex-md-row mb-3">
                        <div className="resume-content mr-auto">
                            ...
                            <div className='subheading mb-3'>Front-End, Back-End</div>
                            <p> Helped create a internal HR tool to help employees who seek to start a business find partners. It also provides SNS features and is seamlessly integrated with both internal and external platforms such as HubSpot.
                            </p>
                            <ul>
                    ...
                    <h2 className="mb-0">Pet Projects & Previous Research</h2>
                </div>
            </section>
        );
    }
