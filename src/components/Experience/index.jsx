                ...
                <div className="my-auto">
                    ...
                    <div className="resume-item d-flex flex-column flex-md-row">
                        <div className="resume-content mr-auto">
                            <h4 className="mb-0">{t('experience.full_time.name')}</h4>
                            <div className="subheading mb-0"><small> {t('experience.full_time.location')}</small></div>
                        ...
                        <div className="resume-date text-md-left">
                            <span className="text-primary">{t('experience.full_time.duration')}</span>
                        </div>
                    </div>
                    <div className="resume-item d-flex flex-column flex-md-row">
                        <div className="resume-content mr-auto">
                            <h4 className="mb-0">{t('experience.part_time.name')}</h4>
                            <div className="subheading mb-0"><small> {t('experience.part_time.location')}</small></div>
